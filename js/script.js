...
const getBooks = async function () {
  try {
    ...
    // pagenationList.innerHTML = null;
    let newErrTex = document.createElement("p");
    newErrTex.setAttribute("class", "err-tex text-center text-info w-100");
    newErrTex.textContent =
      "Bu pageda ma'lumotlar yetarli emas keyigi pagega utishingizni suraymiz";
    cardList.appendChild(newErrTex);
  }
};
